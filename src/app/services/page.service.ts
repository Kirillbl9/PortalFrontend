...
export class PageService {
  ...
  createPage(page: Page, lesson_id: number) {
    ...
    return this.http.post(this.base_url + '/lessons/' + lesson_id + '/pages', {number, name, content}, httpOptions);
  }
  ...
  updatePage(page: Page, lesson_id: number) {
    ...
    return this.http.put(this.base_url + '/lessons/' + lesson_id + '/pages', {page_id, number, name, content}, httpOptions);
  }
}
